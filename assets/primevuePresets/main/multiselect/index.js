  ...
  label: ({ props }) => ({
    class: [
      ...
      'block ',
      {
        ...
        'flex gap-1': props.display === 'chip'
      },

      // Spacing
      {
        'p-2.5': props.display !== 'chip',
        'p-2.5': props.display === 'chip' && !props?.modelValue?.length,
        'py-[0.3rem] px-2.5': props.display === 'chip' && props?.modelValue?.length > 0
      },
